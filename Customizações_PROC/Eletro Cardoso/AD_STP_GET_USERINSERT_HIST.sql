...
********************************************************************************/
    ...
    IF P_TIPOEVENTO = AFTER_INSERT THEN
        ...
        UPDATE AD_TGFPARH SET CODUSU = P_CODUSU, CODUSUALT = P_CODUSU WHERE CODPARC = P_CODPARC AND ID = P_ID;
    ...
    IF P_TIPOEVENTO = AFTER_UPDATE THEN
        ...
        UPDATE AD_TGFPARH SET CODUSUALT = P_CODUSU WHERE CODPARC = P_CODPARC AND ID = P_ID;
